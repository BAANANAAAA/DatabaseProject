        ...
        {isLoggedIn ? (
          <>
            <button className="post-button" onClick={() => setShowNewThreadForm(!showNewThreadForm)}>
              {showNewThreadForm ? 'Close New Thread' : 'Create New Thread'}
            </button>
            <header className="app-header">
              <nav>
                <Link to="/"> Home</Link> |
                <Link to="/user-profile"> User Profile</Link> |
                <Link to="/new-thread"> New Thread</Link> |  {/* Add new link for New Thread */}
            ...
            <Routes>
              ...
              <NewThread onThreadCreated={handleThreadCreated} userId={user.userId} showForm={showNewThreadForm} setShowForm={setShowNewThreadForm} />
