...
function App () {
  ...
  const { avatarURL } = "https://unsplash.com/photos/a-woman-sitting-at-a-table-using-a-laptop-computer-zlRC1ltOWM0"
            ...
            <header className="app-header">
              ...
              <div className="user-info">
                <Link to="/user-profile" style={{ display: 'flex', alignItems: 'center', textDecoration: 'none', color: 'inherit' }}>
                   ...
                   */}
                  <img src={avatarRUL} alt="user avatar" className="user-avatar" />
