...
import ViewNewProfile from './components/ViewNewProfile'
...
function App () {
  ...
  const [refreshMainFrame, setRefreshMainFrame] = useState(false)
          ...
          <>
            <header className="app-header">
              <nav className="main-navigation">
                ...
                <Link className="nav-link" to="/view-new-profile"> New Profile</Link>|
              </nav>
              ...
              <button onClick={handleLogout} style={{ padding: '8px', marginLeft: '-1000px' }}>Logout</button>
            </header>

            <Routes>
              <Route path="/" element={<MainFrame refresh={refreshMainFrame} userId={user.userId} />} />
              ...
              <Route path="/view-new-profile" element={<ViewNewProfile userId={user.userId} />} />
