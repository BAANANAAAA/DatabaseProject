...
function MainFrame() {
  ...
  const [currentReplyId, setCurrentReplyId] = useState(null) // To store the current reply id
  const [selectedTargetType, setSelectedTargetType] = useState('') // To store the selected target type
